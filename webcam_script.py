...
# Allow GPU memory growth so the webcam app doesn't crash your system
...
with tf.Session() as sess:
    ...
    while True:
        ...
        # Safety check in case the webcam drops a frame
        if not ret:
        ...
        if ret:
            ...
            # MODIFIED: .tostring() is deprecated in modern numpy. Use .tobytes()
...
# MODIFIED: Correctly release the capture object we created
cap.release()
