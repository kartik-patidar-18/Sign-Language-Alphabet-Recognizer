...
def plot_confusion_matrix(model_name, y_true, y_pred, classes):
    ...
    # --- ADDED: Print the raw confusion matrix array to the console ---
    print(f"\nRaw Confusion Matrix Array for {model_name}:")
    print(cm)
    print("-" * 30)
...
for model_name, model_file in MODELS_TO_EVALUATE:
    ...
    # Draw and save the Confusion Matrix (and print the array to console)
